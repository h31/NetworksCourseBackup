...
\item{Приём ставок} Сервер принимает от клиентов ставки формата: x;y;z, где x- сумма, y - чет\нечет, z - номер. 
\item{Начало розыгрыша} После приёма ставок сервер принимает от крупье запрос на начало розыгрыша. Формат: 1.
\item{Результаты} После розыгрыша сервер посылает всем результаты игры. Формат: x;y, где x- выиграл\проиграл, y - сумма.
\end{enumerate}
